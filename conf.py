...
BLOG_AUTHOR = "Jeremiah Perry"  # (translatable)
BLOG_TITLE = "Lamentations"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://perryjer1.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://perryjer1.github.io/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "\"Is it nothing to you, all ye that pass by? behold, and see if there be any sorrow like unto my sorrow\""  # (translatable)
